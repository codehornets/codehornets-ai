...
import { isImageFile, isBinaryFile } from './file-reader.js';
// =============================================================================
// Constants
// =============================================================================
/**
 ...
 */
export function computeChecksum(filePath, algorithm = 'sha256') {
 ...
 */
export function computeAttachment(filePath, options = {}) {
    ...
    if (options.computeChecksum) {
        metadata.checksum = computeChecksum(filePath, options.checksumAlgorithm || 'sha256');
    }
    return metadata;
}
/**
 ...
 */
export function createAtMentionAttachment(filePath, cwd) {
 ...
 */
export function parseFilenameWithLineRange(filename) {
