 ...
 */
export const REQUIRED_MANIFEST_FIELDS = ['name', 'version'];
/**
 ...
 * @returns Load result
 */
export async function loadPluginFromDirectory(pluginDir, options = {}) {
 ...
 * @returns Load result
 */
export async function loadPluginFromFile(filePath, options = {}) {
 ...
 */
export function discoverPlugins(searchDir) {
 ...
 */
export function resolvePluginSource(source, baseDir) {
