 ...
 */
export type MCPRequestHandler<TParams, TResult> = (params: TParams) => Promise<TResult>;
/**
 ...
 * Hook event types
 */
export type HookEventType = 'PreToolExecution' | 'PostToolExecution' | 'Notification' | 'Stop' | 'SessionStart' | 'SessionEnd' | 'PreCompact' | 'UserPromptSubmit';
/**
 ...
 */
export type HookInput = PreToolExecutionInput | PostToolExecutionInput | NotificationHookInput | StopHookInput;
/**
 ...
 */
export type HookExecutionResult = HookSuccessResult | HookBlockingResult | HookNonBlockingErrorResult | HookCancelledResult;
/**
 ...
 */
export type HookSpecificOutput = PreToolUseHookOutput | PostToolUseHookOutput | UserPromptSubmitHookOutput | SessionStartHookOutput;
