 ...
 */
export type IdeType = 'vscode' | 'cursor' | 'windsurf' | 'intellij' | 'pycharm' | 'webstorm' | 'phpstorm' | 'rubymine' | 'clion' | 'goland' | 'rider' | 'datagrip' | 'appcode' | 'dataspell' | 'aqua' | 'gateway' | 'fleet' | 'androidstudio';
/**
