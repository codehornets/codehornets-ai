 ...
 */
export type RoleAssumer = (credentials: AWSCredentials, params: AssumeRoleParams) => Promise<AWSCredentials>;
/**
 * Role assumer with web identity function type
 */
export type RoleAssumerWithWebIdentity = (params: AssumeRoleWithWebIdentityParams) => Promise<AWSCredentials>;
/**
 ...
 */
export type AuthSchemeId = 'aws.auth#sigv4' | 'aws.auth#sigv4a' | 'smithy.api#httpApiKeyAuth' | 'smithy.api#httpBearerAuth' | 'smithy.api#noAuth';
/**
 ...
 */
export type CredentialFeature = 'CREDENTIALS_ENV_VARS' | 'CREDENTIALS_ENV_VARS_STS_WEB_ID_TOKEN' | 'CREDENTIALS_PROFILE' | 'CREDENTIALS_PROFILE_NAMED_PROVIDER' | 'CREDENTIALS_PROFILE_SOURCE_PROFILE' | 'CREDENTIALS_PROFILE_SSO' | 'CREDENTIALS_PROFILE_SSO_LEGACY' | 'CREDENTIALS_PROFILE_STS_WEB_ID_TOKEN' | 'CREDENTIALS_PROFILE_PROCESS' | 'CREDENTIALS_PROCESS' | 'CREDENTIALS_STS_ASSUME_ROLE' | 'CREDENTIALS_STS_ASSUME_ROLE_WEB_ID' | 'RESOLVED_ACCOUNT_ID';
/**
 * Credential feature code mapping
 */
export declare const CREDENTIAL_FEATURE_CODES: Record<CredentialFeature, string>;
/**
 * STS error types
 */
export type STSErrorName = 'ExpiredTokenException' | 'MalformedPolicyDocumentException' | 'PackedPolicyTooLargeException' | 'RegionDisabledException' | 'IDPRejectedClaimException' | 'InvalidIdentityTokenException' | 'IDPCommunicationErrorException';
/**
