...
import { authenticate, logout as authLogout, readCredentials, isAuthenticated, getOAuthConfig, } from '../../core/auth.js';
import { green, red, yellow, dim, bold } from '../../core/terminal.js';
/**
 ...
 * @returns Exit code
 */
export async function handleLoginCommand(args, options, context) {
    // Check for help flag
    if (options.help) {
 ...
 * @returns Exit code
 */
export async function handleLogoutCommand(args, options, context) {
    // Check for help flag
    if (options.help) {
 ...
 * @returns Exit code
 */
export async function handleAuthStatusCommand(args, options, context) {
    // Check for help flag
    if (options.help) {
 ...
 * @returns Help text
 */
function generateAuthStatusHelp() {
    return `
