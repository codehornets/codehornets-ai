...
import { generateMainHelp, generateVersionText, } from './help.js';
import { handleMCPCommand, handlePluginCommand, handleDoctorCommand, handleUpdateCommand, handleInstallCommand, handleMigrateInstallerCommand, handleSetupTokenCommand, handleLoginCommand, handleLogoutCommand, handleAuthStatusCommand, resolveCommand, } from './commands/index.js';
 ...
 * @returns Exit code
 */
async function handleInteractiveMode(args, options, context) {
 ...
 * @returns Exit code
 */
async function routeCommand(args, context) {
    ...
    switch (resolvedCommand) {
        ...
        case 'install':
            return handleInstallCommand(subArgs, options, context);
