...
import { resetSharedClock } from './clock.js';
 ...
 */
export function getTelemetryResource() {
 ...
 */
export function createConfigFromEnv(defaults = {}) {
    ...
    return {
        serviceName,
        serviceVersion: resourceAttributes['service.version'] ?? defaults.serviceVersion,
        environment: resourceAttributes['deployment.environment'] ?? defaults.environment,
