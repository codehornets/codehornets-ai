 ...
 */
export type AttributeValueType = string | number | boolean | string[] | number[] | boolean[] | undefined | null;
/**
 ...
 */
export declare const TelemetryEnvVars: {
    /** Service name */
    readonly SERVICE_NAME: "OTEL_SERVICE_NAME";
    /** Resource attributes */
    readonly RESOURCE_ATTRIBUTES: "OTEL_RESOURCE_ATTRIBUTES";
    /** Traces exporter endpoint */
    readonly TRACES_ENDPOINT: "OTEL_EXPORTER_OTLP_TRACES_ENDPOINT";
    /** Metrics exporter endpoint */
    readonly METRICS_ENDPOINT: "OTEL_EXPORTER_OTLP_METRICS_ENDPOINT";
    ...
    /** Enable/disable SDK */
    readonly SDK_DISABLED: "OTEL_SDK_DISABLED";
    /** Log level for diagnostics */
    readonly LOG_LEVEL: "OTEL_LOG_LEVEL";
};
