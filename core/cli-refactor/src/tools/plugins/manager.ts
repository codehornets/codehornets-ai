...
export class PluginManager extends EventEmitter {
   ...
   */
  public getByStatus(status: PluginStatus): Plugin[] {
   ...
   */
  public async discoverAndLoad(): Promise<Plugin[]> {
   ...
   */
  public getErrors(): Array<{ plugin: string; error: Error }> {
    return this.getAll()
      .filter((p) => p.error)
      .map((p) => ({
 ...
 */
export async function createPluginManagerWithDiscovery(
  pluginDirs?: string[]
