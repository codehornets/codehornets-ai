...
export {
  RequestBuilder,
  requestBuilder,
  QUERY_PROTOCOL_HEADERS,
  JSON_PROTOCOL_HEADERS,
  STS_API_VERSION,
  buildHttpRpcRequest,
  deserializeMetadata,
  serializeAssumeRoleRequest,
  serializeAssumeRoleWithWebIdentityRequest,
  parseXmlErrorBody,
  parseXmlBody,
  loadQueryErrorCode,
...
export {
  ...
  ENV_EC2_METADATA_DISABLED,
  ENV_WEB_IDENTITY_TOKEN_FILE,
  ENV_ROLE_ARN,
