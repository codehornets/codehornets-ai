 ...
 */
export const AWS_PARTITIONS: PartitionConfig[] = [
  {
    id: 'aws',
 ...
 */
export function getPartitionForRegion(region: string): PartitionConfig {
 ...
 */
export function getCachedEndpoint(key: string): Endpoint | undefined {
 ...
 */
export function setCachedEndpoint(key: string, endpoint: Endpoint): void {
 ...
 */
export function resolveSTSEndpoint(
  region: string,
 ...
 */
export function updateServiceEndpoint(request: HttpRequest, endpoint: Endpoint): HttpRequest {
...
export async function resolveRegion(
  regionProvider: string | (() => Promise<string>) | undefined,
  parentRegion: string | (() => Promise<string>) | undefined,
  defaultRegion = DEFAULT_STS_REGION,
 ...
 * @returns Updated request
 */
export function setHostPrefix(request: HttpRequest, prefix: string): HttpRequest {
  return {
    ...request,
 ...
 */
export function getAccountIdFromAssumedRoleUser(
