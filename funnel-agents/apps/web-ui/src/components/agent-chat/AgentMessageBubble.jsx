    ...
    <div className="mt-2 text-xs">
      <button
        ...
        className={cn(
          ...
          expanded ? "bg-slate-800/50 border-slate-700" : "bg-slate-800/30 border-slate-700/50"
        )}
      >
...
export default function AgentMessageBubble({ message }) {
  ...
  return (
    <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
      {!isUser && (
        <div className="h-8 w-8 rounded-lg bg-blue-500/10 flex items-center justify-center mt-0.5 flex-shrink-0">
      ...
      <div className={cn("max-w-[75%]", isUser && "flex flex-col items-end")}>
        {message.content && (
          <div className={cn(
            ...
            isUser ? "bg-blue-600 text-white" : "bg-slate-800/50 border border-slate-700"
          )}>
            {isUser ? (
                ...
                components={{
                  code: ({ inline, className, children, ...props }) => {
                    ...
                    return !inline && match ? (
                      ...
                      <code className="px-1 py-0.5 rounded bg-slate-700/50 text-slate-300 text-xs">
                        {children}
                      </code>
                    );
                  },
